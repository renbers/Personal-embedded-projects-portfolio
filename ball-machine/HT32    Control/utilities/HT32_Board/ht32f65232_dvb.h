/*********************************************************************************************************//**
 * @file    ht32f65232_dvb.h
 * @version $Rev:: 8284         $
 * @date    $Date:: 2024-11-22 #$
 * @brief   The header file of HT32F65232 Development Board.
 *************************************************************************************************************
 * @attention
 *
...
#ifndef __HT32F65232_DVB_H
#define __HT32F65232_DVB_H
...
/** @addtogroup HT32F65232_DVB
  * @{
  */


/* Exported constants --------------------------------------------------------------------------------------*/
/** @defgroup HT32F65232_DVB_Exported_Constants HT32F65240 Development Board exported constants
  * @{
  */
extern HT_GPIO_TypeDef* const GPIO_PORT[GPIO_PORT_NUM];

/** @addtogroup HT32F65232_DVB_LED
  * @{
  */
#define LEDn                        (3)
...
/** @addtogroup HT32F65232_DVB_BUTTON
  * @{
  */
#define BUTTONn                     (3)
...
#define KEY1_BUTTON_GPIO_PIN        (GPIO_PIN_8)
#define KEY1_BUTTON_AFIO_MODE       (AFIO_FUN_GPIO)
#define KEY1_BUTTON_EXTI_CHANNEL    (8)
...
/** @addtogroup HT32F65232_DVB_BUZZER
  * @{
  */
...
/** @addtogroup HT32F65232_DVB_SPI_FLASH
  * @{
  */
...
#define FLASH_SPI_MISO_AFIO_PIN     (AFIO_PIN_10)
...
/** @addtogroup HT32F65232_DVB_SPI_LCD
  * @{
  */
...
#define LCD_SPI_MOSI_AFIO_PIN       (AFIO_PIN_11)
#define LCD_SPI_MOSI_AFIO_MODE      (AFIO_FUN_SPI)

#define LCD_SPI_MISO_GPIO_ID        (GPIO_PA)
#define LCD_SPI_MISO_AFIO_PIN       (AFIO_PIN_10)
...
/** @addtogroup HT32F65232_DVB_I2C_EEPROM
  * @{
  */
...
/* Exported functions --------------------------------------------------------------------------------------*/
/** @defgroup HT32F65232_DVB_Exported_Functions HT32F65240 Development Board exported functions
  * @{
  */
